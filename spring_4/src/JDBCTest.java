...
public class JDBCTest {
    ...
    public void testUpdate(){
        ...
        jdbcTemplate.update(sql,"mengmuzi",2);
    }
    ...
    public void testBatchUpdate(){
        ...
        batchArgs.add(new Object[]{4,"cuihua","123"});
        batchArgs.add(new Object[]{5,"wangcai","12312"});
        batchArgs.add(new Object[]{6,"laifu","1213"});
        batchArgs.add(new Object[]{7,"xiaoqiang","32123"});
    ...
    public void testQueryForObject(){
        ...
        RowMapper<Employee> mapRowMapper = new BeanPropertyRowMapper<>(Employee.class);

        Employee employee = jdbcTemplate.queryForObject(sql,mapRowMapper,1);
    ...
    public void testQueryForList(){
        ...
        List<Employee> employees = jdbcTemplate.query(sql,mapper,5);
